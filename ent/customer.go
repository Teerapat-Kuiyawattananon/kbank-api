...
func (*Customer) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case customer.FieldFirstName, customer.FieldLastName, customer.FieldTitleName, customer.FieldMobileNumber:
...
func (c *Customer) QueryBills() *BillQuery {
	return NewCustomerClient(c.config).QueryBills(c)
}
...
func (c *Customer) String() string {
	...
	builder.WriteString(c.TitleName)
	builder.WriteString(", ")
